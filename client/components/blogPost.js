        ...
        {this.state &&
          this.state.blogPost[0] && (
            <div className="blogPost">
              <div>
                <img
                  src="../images/blogger/post_background.png"
              ...
              <div className="blogPostContent">
                ...
                />
                <div>
                  <text className="tealSubHeaderPost">
                    POSTED ON {this.state.blogPost[0].acf.date.toUpperCase()}
                  </text>
                </div>
                ...
                {this.state.blogPost[0].acf.image && (
                  <div className="videoContainer">
                    <img
                      src={this.state.blogPost[0].acf.image}
                      className="blogPostBackground"
                    />
                  </div>
                )}
